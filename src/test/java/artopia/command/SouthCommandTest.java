 ...
 * @author Vehsamrak
 */
public class SouthCommandTest extends Assert
{
    ...
    private RoomRepository createRoomRepository()
    {
        ...
        when(roomRepository.findById("test-south")).thenReturn(southRoom);
